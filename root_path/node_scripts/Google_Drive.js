...
const backup_json = JSON.parse(fs.readFileSync(path.resolve("/node_script/drive_api.json")).toString().split("@DOMAIN_REQUEST").join(process.env.NODE_REQUEST_DRIVE))
